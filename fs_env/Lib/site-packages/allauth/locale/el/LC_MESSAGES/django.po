...
"από τους ήδη υπάρχοντες εξωτερικούς λογαριασμούς σας. Ή, <a href="
"\"%(signup_url)s\">κάντε εγγραφή</a>\n"
...
"χρησιμοποιηθεί.  Παρακαλούμε κάντε εκ νέου <a href=\"%(passwd_reset_url)s"
"\">επαναφορά συνθηματικού</a>."
...
"mail address</a>."
msgstr ""
"<strong>Σημείωση:</strong> μπορείτε ακόμα να <a href=\"%(email_url)s"
"\">αλλάξετε τηνδιεύθυνση e-mail σας</a>."
...
"υπάρχοντες λογαριασμούς σας. Αν έγινε κατά λάθος, παρακαλώ <a href="
"\"%(login_url)s\">συνδεθείτε</a>."
